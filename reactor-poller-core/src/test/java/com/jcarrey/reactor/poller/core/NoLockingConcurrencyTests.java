...
public class NoLockingConcurrencyTests {
    ...
    public void scalesUpBasedOnStrategy() {
        ...
        Mockito.verify(scaleUp, atLeastOnce()).calculateDelta(5, ScaleUp);
        Mockito.verify(scaleUp, atLeastOnce()).calculateDelta(6, ScaleUp);
        Mockito.verify(scaleUp, atLeastOnce()).calculateDelta(7, ScaleUp);
        Mockito.verify(scaleUp, atLeastOnce()).calculateDelta(8, ScaleUp);
        Mockito.verify(scaleUp, atLeastOnce()).calculateDelta(9, ScaleUp);
    ...
    public void scalesDownBasedOnStrategy() {
        ...
        Mockito.verify(scaleDown, atLeastOnce()).calculateDelta(5, ScaleDown);
        Mockito.verify(scaleDown, atLeastOnce()).calculateDelta(4, ScaleDown);
        Mockito.verify(scaleDown, atLeastOnce()).calculateDelta(3, ScaleDown);
        Mockito.verify(scaleDown, atLeastOnce()).calculateDelta(2, ScaleDown);
